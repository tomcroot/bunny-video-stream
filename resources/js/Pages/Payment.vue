<template>
    <div class="min-h-screen bg-background text-foreground flex flex-col">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6 lg:space-y-8">
                        ...
                        >
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                <div
                                    ...
                                    class="shrink-0 w-24 h-32 mx-auto sm:mx-0"
                                >
                                    <img
                                        :src="movie.image_url"
                                        :alt="movie.title"
                                ...
                                <div class="flex-1">
                                    <h3
                                        class="text-xl font-bold text-foreground mb-2"
                                    >
                                        {{
                                            movie?.title ||
                                    ...
                                    <p class="text-muted-foreground mb-4">
                                        {{
                                            movie?.description ||
                                            "Unlimited streaming access to this film."
                                        }}
                                    </p>
                        ...
                        >
                            ...
                            <div class="space-y-3">
                                <label
                                    class="flex items-center p-3 sm:p-4 border-2 border-border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors"
                                    :class="{
                                ...
                                >
                                    ...
                                    <span class="ml-3 flex-1"
                                        ><span class="font-medium block"
                                            >Mobile Money (Recommended)</span
                                        >
                                        <p
                                            class="text-sm text-muted-foreground"
                                        >
                                            MTN, Vodafone, AirtelTigo – fast and
                                            reliable.
                                        </p></span
                                    >
                                </label>
                        ...
                        >
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <input
                                    v-model="couponCode"
                                    type="text"
                                    placeholder="Enter promo/referral code (optional)"
                        ...
                        >
                            ...
                            <p class="text-sm text-muted-foreground mt-2">
                                Leave empty to use your phone number as default
                                email.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="bg-card border border-border rounded-lg p-4 sm:p-6 lg:sticky lg:top-6"
                        >
                            <h2
                                class="text-lg font-semibold text-foreground mb-4"
                            >
                            ...
                            <div
                                class="flex justify-between text-lg font-bold pt-4 mb-6"
                            >
                                <span>Total</span
                            ...
                            <button
                                ...
                                :disabled="processing"
                                class="w-full bg-primary text-primary-foreground py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50"
                            >
                                {{
                                    processing
                                        ? "Processing..."
        ...
        <!-- Status Overlay -->
        <div
            v-if="statusOverlay.visible"
            class="fixed inset-0 z-40 bg-black/80 backdrop-blur-sm flex items-center justify-center px-6"
        >
            <div
                class="max-w-md w-full bg-card border border-border rounded-2xl p-6 text-center"
            >
...
const showStatusOverlay = (t, m) =>
    (statusOverlay.value = { visible: true, title: t, message: m });
