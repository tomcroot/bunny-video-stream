      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          <div>
            ...
            <p class="text-muted-foreground">Manage Page Content</p>
          </div>
          <Link
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="bg-card rounded-lg shadow">
        <div class="px-6 py-4 border-b border-border">
          <h2 class="text-lg font-semibold text-foreground">Page Content</h2>
        </div>

        <div class="p-6">
          <div v-if="pageContent.length === 0" class="text-center py-8">
            <p class="text-muted-foreground">No page content found. Add your first content block to get started.</p>
          </div>
          ...
          <div v-else class="space-y-4">
            ...
            >
              <div class="flex items-center space-x-4">
                <div>
                  <h3 class="font-medium text-foreground">{{ content.title }}</h3>
                  <p class="text-sm text-muted-foreground">{{ content.page }} - {{ content.section }}</p>
              ...
              <div class="flex items-center space-x-2">
                <Link
                  :href="`/admin/page-content/${content.id}`"
...
const pageContent = computed(() => props.pageContent ?? [])
