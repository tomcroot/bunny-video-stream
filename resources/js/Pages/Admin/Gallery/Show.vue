            ...
            <div>
              ...
              <dl class="space-y-3">
                <div>
                  ...
                  <dd class="text-foreground">{{ image.title }}</dd>
                </div>
                <div>
                  <dt class="text-sm font-medium text-muted-foreground">Description</dt>
                  <dd class="text-foreground">{{ image.description || 'No description' }}</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd class="text-foreground">{{ image.display_order }}</dd>
                </div>
              </dl>
            </div>
          ...
          <div class="mt-8 pt-6 border-t border-border">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <dd class="text-foreground">{{ formatDate(image.created_at) }}</dd>
              </div>
              <div>
                <dt class="text-sm font-medium text-muted-foreground">Last Updated</dt>
                <dd class="text-foreground">{{ formatDate(image.updated_at) }}</dd>
              </div>
            </div>
          </div>
        </div>
