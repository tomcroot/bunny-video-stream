        ...
        <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-muted-foreground">
                    Configure your application environment variables. Changes
            ...
            >
                Settings updated successfully! Please restart your application
            ...
            <form @submit.prevent="handleSubmit">
                ...
                <div
                    v-for="(settings, sectionName) in envStructure"
                    :key="sectionName"
                    class="mb-8"
                >
                    <div class="bg-card rounded-lg shadow-md overflow-hidden">
                        <!-- Section Header -->
                        <div
                            class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4"
                        >
                ...
                <!-- Actions -->
                <div
                    class="flex flex-wrap gap-3 sticky bottom-4 bg-background p-4 rounded-lg shadow-lg border border-border"
                >
                    <button
                        type="submit"
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>
                                    Sensitive values (passwords, keys, secrets)
                                    are masked for security
                                </li>
                                <li>
                                    Make sure to backup your .env file before
                                    making changes
                                </li>
                                <li>
                                    Invalid configurations may cause your
                                    application to fail
                                </li>
                                <li>
                                    Database settings: Use the Database Settings
                                    page for runtime settings
                                </li>
                            </ul>
                        </div>
                    </div>
